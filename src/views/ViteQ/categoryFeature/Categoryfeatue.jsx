...
export default () => {
    ...
    const postData = async (datapost) => {
        ...
        const { data, status } = await repository.add_category_feature(postData).then(x => x).then(x => x)
                                ...
                                <Col xs={12} md={12}>
                                    ...
                                    <div className="page-title">
                                        <div className="float-left">
                                            <h1 className="title">Add Sub Category Feature</h1>
                                        </div>
                                    </div>
                                                            ...
                                                            <form>
                                                                <div className="form-row">
                                                                    <div className="form-group col-md-6">
                                                                        ...
                                                                        <select  {...getFieldProps("category_id")} onChange={(e) => {
                                                                    ...
                                                                    <div className="form-group col-md-6">
                                                                        ...
                                                                        <select  {...getFieldProps("input_type")} onChange={(e) => {
