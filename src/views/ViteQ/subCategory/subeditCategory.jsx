...
export default (props) => {
    ...
    const postData = async (datapost) => {
        ...
        const { data, status } = await repository.edit_category(postData).then(x => x).then(x => x)
    ...
    return (loaderMain ? <></> : <Formik
        initialValues={{
            ...
            image: '',
            parent_id: props.location&&props.location.state&&props.location.state.data&&props.location.state.data.parent_id?props.location.state.data.parent_id:"",
        }}
                                                            ...
                                                            <form>
                                                                ...
                                                                <div className="form-row">
                                                                    <div className="form-group col-md-6">
                                                                        ...
                                                                        <select  {...getFieldProps("parent_id")} onChange={(e) => {
                                                                        ...
                                                                        {touched.parent_id && errors.parent_id && <div style={{ color: 'red', marginTop: 10 }}>{errors.parent_id}</div>}
