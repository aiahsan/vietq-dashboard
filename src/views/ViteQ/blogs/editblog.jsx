...
export default (props) => {
    ...
    const [image, setimage] = useState(props.location && props.location.state && props.location.state.data && props.location.state.data.cover_image ? props.location.state.data.cover_image : "");
    const [hasImage, sethasImage] = useState(null);
    const [progress, setProgress] = useState(0)
    const refContainer = React.useRef(null);
    const [editorState, seteditorState] = useState(
        draftToHtml(convertFromHTML(props.location && props.location.state && props.location.state.data && props.location.state.data.full_content ? props.location.state.data.full_content:"")))
    useEffect(() => {
    ...
    const postData = async (datapost) => {
        ...
        console.log(postData,"post images");
        const { data, status } = await repository.edit_blog(postData).then(x => x).then(x => x)
    ...
    return (loaderMain ? <></> : <Formik
        initialValues={{
            blog_id: props.location && props.location.state && props.location.state.data && props.location.state.data.id ? props.location.state.data.id : "",
            title: props.location && props.location.state && props.location.state.data && props.location.state.data.title ? props.location.state.data.title : "",
            cover_image: '',
            blog_cat_id: props.location && props.location.state && props.location.state.data && props.location.state.data.blog_cat_id ? props.location.state.data.blog_cat_id : "",
            meta_title: props.location && props.location.state && props.location.state.data && props.location.state.data.meta_title ? props.location.state.data.meta_title : "",
            meta_description: props.location && props.location.state && props.location.state.data && props.location.state.data.meta_description ? props.location.state.data.meta_description : "",
            meta_keywords: props.location && props.location.state && props.location.state.data && props.location.state.data.meta_keywords ? props.location.state.data.meta_keywords : "",
            short_content: props.location && props.location.state && props.location.state.data && props.location.state.data.short_content ? props.location.state.data.short_content : "",
        }}
                                                            ...
                                                            <form>
                                                                <div className="form-row">
                                                                    ...
                                                                    <div className="form-group col-md-6">
                                                                        ...
                                                                        <select value={initialValues.blog_cat_id}  {...getFieldProps("blog_cat_id")} onChange={(e) => {
