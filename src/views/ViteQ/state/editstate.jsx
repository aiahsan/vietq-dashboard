...
export default (props) => {
    ...
    const postData = async (datapost) => {
        ...
        const { data, status } = await repository.edit_states(postData).then(x => x).then(x => x)
    ...
    return (loaderMain ? <></> : <Formik
        initialValues={{
            state_id:props.location&&props.location.state&&props.location.state.data&&props.location.state.data.id?props.location.state.data.id:"",
                                ...
                                <Col xs={12} md={12}>
                                    ...
                                    <div className="page-title">
                                        <div className="float-left">
                                            <h1 className="title">Edit States</h1>
                                        </div>
                                    </div>
