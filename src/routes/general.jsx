...
var dashRoutes = [
    ...
    { path: BASEDIR + "/calendar1", name: "Home", icon: "calendar1", component: Calendar },
    {


        path: "#", name: "Users", icon: "speedometer", type: "dropdown", parentid: "users",
        child: [
            { path: BASEDIR + "/dashboard3", name: "Add New" },
            { path: BASEDIR + "/dashboard", name: "View Users" },
    ...
    },
    {
        ...
        path: "#", name: "Category", icon: "speedometer", type: "dropdown", parentid: "categories",
        child: [
            { path: BASEDIR + "/dashboard3", name: "Add New Category" },
            { path: BASEDIR + "/dashboard", name: "View Categories" },
            { path: BASEDIR + "/dashboard3", name: "Add New Category Features" },
            { path: BASEDIR + "/dashboard", name: "View Category Features" },
    ...
    },
    {
        ...
        path: "#", name: "Listings", icon: "speedometer", type: "dropdown", parentid: "listings",
        child: [
            { path: BASEDIR + "/dashboard3", name: "Add New Listing" },
            { path: BASEDIR + "/dashboard", name: "View Listings" },
            { path: BASEDIR + "/dashboard3", name: "Add New Category Features" },
            { path: BASEDIR + "/dashboard", name: "View Category Features" },
    ...
    },
    {
        ...
        path: "#", name: "Blogs", icon: "speedometer", type: "dropdown", parentid: "blogs",
        child: [
            { path: BASEDIR + "/dashboard3", name: "Add New Blog Category" },
            { path: BASEDIR + "/dashboard", name: "View Blogs Categories" },
            { path: BASEDIR + "/dashboard3", name: "Add New Blog" },
            { path: BASEDIR + "/dashboard", name: "View Blogs" },
         

        ]
    },
    { path: BASEDIR + "/calendar1", name: "Profile", icon: "calendar1", component: Calendar },
    { path: BASEDIR + "/calendar1", name: "About", icon: "calendar1", component: Calendar },
    { path: BASEDIR + "/calendar1", name: "Contact Us", icon: "calendar1", component: Calendar },
    { path: BASEDIR + "/calendar1", name: "Logout", icon: "calendar1", component: Calendar },
    {
