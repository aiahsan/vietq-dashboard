...
class Sidebar extends React.Component{
    ...
    componentDidMount(){
        ...
        if(this.props.admintype === 'general'){
            this.setState({     
                profileposition: 'Admin Vietq',
                profileimg: this.props.User!=null?this.props.User.image:"https://www.freeiconspng.com/img/23483" ,
                profilename: this.props.User!=null?this.props.User.name:""
                    ...
                    <Nav className="navigation">
                        {
                            this.props.routes.map((prop,key) => {
                                ...
                                if(prop.type === "dropdown-backup")
                                    ...
                                    if(prop.type === "logout")
                                    return  (<li className={this.activeRoute(prop.path) + ' nav-parent '} key={key} onClick={() => this.props.LogOut()}>
